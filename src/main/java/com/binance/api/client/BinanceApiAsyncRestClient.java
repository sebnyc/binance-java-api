...
public interface BinanceApiAsyncRestClient {
   ...
   * @param callback the callback that handles the response with a list of trades
   */
  void getMyTrades(String symbol, Integer limit, Long fromId, BinanceApiCallback<List<Trade>> callback);
   ...
   *
   * @param callback the callback that handles the response and returns the dividend history
   */
   ...
   * Get lending account
   */
  void getLendingAccount(BinanceApiCallback<LendingAccount> callback);
